...
const Hero = () => {
  return (
    <section
      id="hero"
className="scroll-mt-24 min-h-[calc(100vh-80px)] flex items-center justify-center px-4 py-6 md:py-10 bg-zinc-50"    >
        ...
        <div className="text-center md:text-left order-2 md:order-1">
          ...
          <div className="mt-6 flex gap-4 flex-wrap justify-center md:justify-start">
            <a
              ...
              download
              className="
                px-6 py-3 bg-black text-white rounded-xl font-medium
            ...
            <a
              href="#contact"
              className="
                px-6 py-3 border border-gray-300 rounded-xl font-medium text-gray-700
                transition-all duration-300 ease-out
